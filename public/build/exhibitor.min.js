...
(function(e){var r=require("./exhibitor");if(exports.Exhibitor=r,exports.bootstrap=function(e){return new r(e)},e.browser)exports.version="1.0.0",exports.homepage=",";else{var o=require("../package.json");exports.version=o.version,exports.homepage=o.homepage}}).call(this,require("_process"));
},{"../package.json":5,"./exhibitor":6,"_process":2}],2:[function(require,module,exports){
...
function Exhibitor(e,t){var i=this;this.element=$(e||".exhibitor:first"),this.options=_.merge(_.cloneDeep(defaultOptions),t),this.themes=themes.slice(),this.themes.forEach(function(e){e.name=_S.trim(e.name||_S.titleize(_S.humanize(e.id))),e.regex=new RegExp("^"+e.name,"gi")}),this.element.addClass("map-mode"),this.themeLiTemplate=this.element.find("ol.themes li:first")[0].outerHTML,this.itemLiTemplate=this.element.find("ol.items li:first")[0].outerHTML,this.element.find("ol.themes li,ol.items li").remove(),this.element.on("click",".themes li > div > a",function(){i.select($(this).closest("li").data("theme"))}),this.element.on("click",".themes li .love-toggle",function(e){e.stopPropagation(),i.loveToggle($(this).closest("li").data("theme"))}),this.element.on("click",".back-to-map",function(){i.goToMap()});var s=this.queryInput=this.element.find("form [name=q]");this.element.on("submit","form",function(e){e.preventDefault(),i.query(s.val())}),s.on("input",function(){var e=s.val();i.query(e)}).keydown(function(e){9===e.which&&(e.preventDefault(),i.queryComplete())});var o=/#?q=(.+)/.exec(document.location.hash||""),a="";o&&(a=decodeURIComponent(o[1]),s.val(a)),this.query(a)}function removeWithDelay(e,t){setTimeout(function(){e.is(".removed")&&e.remove()},t)}function appearWithDelay(e,t){setTimeout(function(){$(e).removeClass("just-appeared")},t)}var _=require("lodash"),_S=require("underscore.string"),themes=require("./themes"),defaultOptions={};Exhibitor.prototype.select=function(e){this.element.addClass("exhibition-mode").removeClass("map-mode"),this.element.find(".themes li").removeClass("exhibited"),this.element.find(".themes .theme-"+e).addClass("exhibited");var t=this.element.find(".items");t.empty();for(var i=0;29>i;i++){var s=$(this.itemLiTemplate);s.find("h3").text("Product Name #"+i),s.addClass("item-index-"+i),t.append(s)}},Exhibitor.prototype.queryComplete=function(){var e=this.queryInput,t=e.data("autocomplete-suggestion")+" ";_S.trim(t)&&(e.val(t),this.query(t),e.focus().val("").val(t))},Exhibitor.prototype.loveToggle=function(e){var t=_.find(themes,{id:e});t.love=!t.love;var i=this.element.find(".map li.theme-"+e);t.love?i.addClass("loved-theme"):i.removeClass("loved-theme")},Exhibitor.prototype.goToMap=function(){this.element.removeClass("exhibition-mode").addClass("map-mode"),this.element.find(".exhibited").removeClass("exhibited")},Exhibitor.prototype.query=function(e){function t(t){var i=e.replace(t.regex,"");i!==e&&(o=!0,e=_S.trim(i),a.push(t),t.exactMatch=!0)}function i(){n||(n=!0,s.element.addClass("has-autocomplete-suggestion"),s.queryInput.data("autocomplete-suggestion",a.map(function(e){return e.name}).join(" "))),m++,a[a.length-1].suggestion=m}var s=this,o=!0;if(this.queryInput.data("autocomplete-suggestion",""),s.element.removeClass("has-autocomplete-suggestion"),"undefined"==typeof e||null===e||""===e)return this.themes=themes.slice(),themes.forEach(function(e){delete e.exactMatch,delete e.suggestion}),this.updateThemeList(),void history.replaceState(void 0,void 0,"#");history.replaceState(void 0,void 0,"#?q="+encodeURIComponent(e)),e=_S.trim(e||"").replace(/[ ,]+/g," ").toLowerCase();var a=[];for(themes.forEach(function(e){delete e.exactMatch,delete e.suggestion});o;)o=!1,themes.forEach(t);var n=!1,m=0;""!==e&&(themes.forEach(function(t){a.indexOf(t)>=0||t.name.substr(0,e.length).toLowerCase()===e&&(a.push(t),i())}),themes.forEach(function(t){a.indexOf(t)>=0||_.any(t.name.toLowerCase().split(" "),function(t){return t.substr(0,e.length)===e})&&(a.push(t),i())})),this.themes=a,this.updateThemeList()},Exhibitor.prototype.updateThemeList=function(e){var t=this;e=e||this.themes;var i,s,o=this.element.find("ol.themes"),a={};e.length?this.element.addClass("not-empty").removeClass("empty"):this.element.addClass("empty").removeClass("not-empty"),o.find("li").each(function(){s=$(this);var t=s.data("theme"),o=_.findIndex(e,{id:t});if(i=e[o],0>o)s.addClass("removed"),removeWithDelay(s,1e3);else{var n=s.data("theme-index");n!==o&&(s.addClass("theme-index-"+o),"number"==typeof n&&s.removeClass("theme-index-"+n),s.data("theme-index",o)),s.removeClass("removed"),a[o]=!0}s.removeClass("exact-match suggestion"),i&&(i.exactMatch?s.addClass("exact-match"):i.suggestion&&s.addClass("suggestion"))});for(var n=e.length,m=0;n>m;m++)a[m]||(i=e[m],s=$(this.themeLiTemplate),s.find("h2").text(i.name),s.addClass("just-appeared"),appearWithDelay(s,5),s.addClass("theme-"+i.id),s.addClass("theme-index-"+m),s.data("theme",i.id),s.data("theme-index",m),i.love&&s.addClass("loved-theme"),i.exactMatch?s.addClass("exact-match"):i.suggestion&&s.addClass("suggestion"),o.append(s));setTimeout(function(){t.sortThemeElements()},1e3)},Exhibitor.prototype.sortThemeElements=function(){var e=$(this.element).find("ol.themes");e.find("li").sort(function(e,t){return $(e).data("theme-index")>$(t).data("theme-index")}).each(function(){var t=$(this),i=t.data("theme-index");i!==t.index()&&t.insertBefore(e.children("li").get(i))})},module.exports=Exhibitor;
},{"./themes":7,"lodash":3,"underscore.string":4}],7:[function(require,module,exports){
var themes=[];module.exports=themes,themes.push({id:"christopher-kane",type:"brand"}),themes.push({id:"alexander-wang",type:"brand"}),themes.push({id:"alexander-mc-queen",type:"brand"}),themes.push({id:"hipster-island",type:"magazine"}),themes.push({id:"balenciaga",type:"brand"}),themes.push({id:"leather-gloves",type:"category"}),themes.push({id:"acne-studios",type:"brand"}),themes.push({id:"jason-wu",type:"brand"}),themes.push({id:"scarves",type:"category"}),themes.push({id:"shoes",type:"category"}),themes.push({id:"high-heels",type:"category"}),themes.push({id:"sunglasses",type:"category"}),themes.push({id:"trenches",type:"category"}),themes.push({id:"winter",type:"season"}),themes.push({id:"summer",type:"season"});
},{}]},{},[1])(1)
});


//# sourceMappingURL=exhibitor.min.map